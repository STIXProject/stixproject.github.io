...
See the [Versioning guide](/documentation/concepts/versioning)  for implementation guidance.

These should *always* include a `version` attribute using `@id` and `@timestamp` to allow for content updates and revisions.
