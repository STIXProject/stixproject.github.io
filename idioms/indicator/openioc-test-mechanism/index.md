...
The information that the producer provides is simply the OpenIOC signature and the fact that it indicates Zeus malware. The [Malware Hash](http://stixproject.github.io/idioms/indicator/malware-hash/) idiom describes, we can use the [Indicator](/documentation/indicator/IndicatorType) and [TTP](/documentation/ttp/TTPType) components to describe this type of relationship. Unlike in that idiom however, in this case we'll provide the OpenIOC test mechanism in the indicator rather than a CybOX pattern.
...
* The [TTP idioms](../../ttp) describe other usage of [TTP](/documentation/ttp/TTPType), which may be helpful when giving OpenIOC indicators context.
* The [OpenIOC2010TestMechanism](/documentation/stix-openioc/OpenIOC2010TestMechanismType/) data model documentation has more information on other fields that are available.
